...
\date{Maringá, 2024}
    ...
    \part[Consciência]{Consciência}
        ...
        Entre as décadas de 1960 e 1980, mais de 70 loteamentos foram criados e ``[a] transformação de uso dos lotes periurbanos deu-se de maneira fácil e contraditória, rompendo o cinturão verde constante do plano original''. Nesses loteamentos ficou clara a preocupação apenas com ``a contabilidade das áreas vendáveis'', com loteamentos sem nenhuma área livre e um grande número de lotes ``em áreas de formatos irregulares'' (Meneguetti, 2007, pp. 96-97). 
