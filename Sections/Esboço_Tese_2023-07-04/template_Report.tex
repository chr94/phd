...
\end{abstract}
	...
	%%%% OBSERVAÇÕES RENATO 19SET2023 13:38 ``O método tem de ser claro, objetivo, direto. Ou seja, ele tem que ser simples para ser inteligível. Grosso modo, o que você tem que fazer é: a partir de algumas premissas, de alguns pressupostos e de um certo padrão, que a gente pode dizer de excelência, [você vai] desenvolver projeto urbano. Feito o projeto, você vai: avaliar o produto (ou seja, resultado do projeto) diante daquele padrão, daqueles pressupostos e das premissas que você considerou. Feito isto – imaginando que você vai chegar a um resultado dizendo que o produto coincide com aquelas condicionantes – você vai avaliar o processo de projeto, a ferramenta ou o instrumento que você usou pra fazer o projeto – entendendo aí a configuração, a conformação da forma urbana –, e é esta ferramenta que pode ser depois replicada.
